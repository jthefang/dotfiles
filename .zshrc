...
export ZSH="/Users/jfang/.oh-my-zsh"
...
# displays the command prompt (current working directory, the current command history number, and the shell type)
export PS1="\W (\!):"

#ALIASES
alias ls='ls -F'
#interactive mode will prompt you before overwriting or deleting a file (so you don't accidentally lose data)
alias rm="rm -i"
alias cp="cp -i"
alias mv="mv -i"
...
#blocksize when displaying file sizes (in blocks of 1kB instead of default 512 bytes)
export BLOCKSIZE=1024
##
# Your previous /Users/jfang/.bash_profile file was backed up as /Users/jfang/.bash_profile.macports-saved_2017-09-14_at_11:41:53
##
